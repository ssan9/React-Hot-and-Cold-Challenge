...
export default function InfoSection() {
  return (
    <section id="what" tabIndex="-1">
      ...
      <p>
        If you're using a screen reader, you can use the visually hidden "Hear
        state of game" link in the navigation region to get a reminder of all of
        your past guesses and how close your current guess is to being correct.
      </p>
    </section>
  );
}
